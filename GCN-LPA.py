...
def draw_nx(com):
    ...
    for i in range(len(com)):
        nx.draw_networkx_nodes(G, pos, 
                            ...
                            label=True)
    plt.show()
    plt.savefig('/home/zhangziyi/code/ProvinceCuisineDataMining/Log/'+start_time[:10]+'/'+start_time[11:]+'/GCN-LPA_nx')
...
def draw(z,r):
    ...
    plt.axis('off')
    plt.show()
    plt.savefig('/home/zhangziyi/code/ProvinceCuisineDataMining/Log/'+start_time[:10]+'/'+start_time[11:]+'/GCN-LPA')    
